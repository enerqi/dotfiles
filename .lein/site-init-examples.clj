;; Auto loaded code on clojure startup into the 'user' namespace.


;; Firstly we want the option to 'require' all the namespaces on the classpath
...
(defn setup-repl []
  ...
  (alter-var-root #'*print-level* (constantly 13))
